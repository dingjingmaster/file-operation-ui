...
FileOperationErrorHandler::ResponseInfo FileOperationErrorDialog::handleError(const QString &srcUri, const QString &destDirUri, const GErrorWrapperPtr &err, bool isCritical)
{
...
FileOperationErrorHandler::ResponseInfo *FileOperationErrorHandler::handleError(const QString &srcUri, const QString &destDirUri, const GErrorWrapperPtr &err, bool isCritical)
{


}

//virtual ResponseInfo handleError(QString dialog,
//                                 const QString &srcUri, const QString &destDirUri,
//                                 const GErrorWrapperPtr &err, bool isCritical = false) = 0;
//{
//    for (int i = 3; i < 8; i++) {
